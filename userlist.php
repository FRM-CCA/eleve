...
try {
	...
	$query = "SELECT `Id`, `Nom`, `Prenom`, `DateNaissance`, `Classe`, 
		...
		`CodePostal`, `Ville`, `DateCreation`, `DateModification` FROM `eleve` ";
...
//	var_dump($row);
	$dbid = $row["Id"];
	$table .= '<tr>';
	$table .= '<td><a href="userfrmlist.php?method=update&id='.$dbid.'"><img class="update" src="icons/editBlack.png" alt="Edit"></a></td>';
	$table .= '<td><a href="userfrmlist.php?method=delete&id='.$dbid.'"><img class="delete" src="icons/crossBlack.png" alt="Delete"></a></td>';
	$cptCol=-1;
...
<body>
<h2>Student:</h2>
<a id="addUserLink" class="btn default" href="userfrm.php"><img class="user" src="icons/userBlack.png" alt="User">&nbsp;&nbsp;Add User</a>
<?php
